...
class StarterSite extends TimberSite {
  ...
  function __construct() {
    ...
    function enqueue_styles() {
		wp_enqueue_script( 'my-css', get_template_directory_uri(). '/assets/dev/css/prjct_boilerplate-main.css', false ); 
	}
    ...
    function enqueue_scripts() {
        ...
        //     );
        // }
        wp_enqueue_script( 'my-js', get_template_directory_uri(). '/assets/dev/js/prjct_boilerplate-main.js', false );
    }
